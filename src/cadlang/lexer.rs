...
fn decode_buffer(buffer: &str, start: Location) -> Token {
    match buffer {
        ...
        "auto_increment" => {
            Token::new(TokenType::AutoIncrement, start) 
        }
        "auto_entry" => {
            Token::new(TokenType::AutoEntry, start) 
        }
        "validation_message" => {
...
table %1 Person {
    field %1 id = {
        ...
        let expected = vec![
            ...
            Token::new(TokenType::AutoIncrement, Location { line: 4, column: 8 }),
            Token::new(TokenType::Assignment, Location { line: 4, column: 22 }),
            Token::new(TokenType::True, Location { line: 4, column: 23 }),
            Token::new(TokenType::Comma, Location { line: 4, column: 27 }),
            ...
            Token::new(TokenType::AutoEntry, Location { line: 7, column: 8 }),
            Token::new(TokenType::Assignment, Location { line: 7, column: 19 }),
            Token::with_value(TokenType::Calculation, Location { line: 7, column: 21 }, "get(uuid)".to_string()),
            Token::new(TokenType::Comma, Location { line: 7, column: 31 }),
