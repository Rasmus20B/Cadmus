...
#[repr(u16)] pub enum Instruction {
	...
	If { condition: Calculation } = 68,
	Else = 69,
	EndIf = 70,
	Loop = 71,
	ExitLoopIf { condition: Calculation }  = 72,
	EndLoop = 73,
	...
	ExitScript { value: Calculation } = 103,
	DeletePortalRow = 104,
	OpenPreferences = 105,
	CorrectWord = 106,
	SpellingOptions = 107,
	...
	SelectWindow = 123,
	SetWindowTitle = 124,
	ElseIf { condition: Calculation } = 125,
	...
	SetVariable { name: String, value: Calculation, repetition: Calculation } = 141,
	InstallMenuSet = 142,
